...
const ManagementDrawer = ({ session, state, action = "add", data, selectedItemId, getNavigationData, onStateUpdate }: any) => {
    ...
    const alert = (
        <Alert status="fail" variant="standard" action={<Button type="button" mode="secondary" variant="outline" size="XS" content="icon" onClick={() => setShowError(false)}><FontAwesomeIcon icon="close" /></Button>}>
